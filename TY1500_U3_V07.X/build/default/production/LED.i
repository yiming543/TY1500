...
# 349 "./mcc_generated_files/pin_manager.h"
...
void PWM_DRL(void) { EPWM1_LoadDutyValue((599+1)); }
void PWM_POS(void) { EPWM1_LoadDutyValue((59+1)); }
void PWM_turn_signals(void) { EPWM1_LoadDutyValue((999+1)); }
...
void yellow_seg5_backward(void) {
  for (int8_t pwm_idx = 10; pwm_idx > 0; pwm_idx--) {
    if (PORTBbits.RB1)
      break;
    for (uint8_t ii = 0; ii < 7; ii++) {
...
void yellow_seg6_backward(void) {
  for (int8_t pwm_idx = 10; pwm_idx > 0; pwm_idx--) {
    if (PORTBbits.RB1)
      break;
    for (uint8_t ii = 0; ii < 7; ii++) {
...
void yellow_seg7_backward(void) {
  for (int8_t pwm_idx = 10; pwm_idx > 0; pwm_idx--) {
    if (PORTBbits.RB1)
      break;
    for (uint8_t ii = 0; ii < 7; ii++) {
...
void check_welcome_light(void) {
  ...
  case WELCOME_STEP_7:
    ...
    yellow_seg5_backward();
    eWelcome_step++;
    break;
    case WELCOME_STEP_13:
    yellow_seg6_backward();
    eWelcome_step++;
    break;

    case WELCOME_STEP_14:
    yellow_seg7_backward();
    delay_ms(250);
    eWelcome_step++;
    break;
    ...
    case WELCOME_STEP_18:
    yellow_seg4_forward();
    eWelcome_step++;
    break;
  case WELCOME_STEP_19:
    yellow_seg5_forward();
    eWelcome_step++;
    break;
  case WELCOME_STEP_20:
    yellow_seg6_forward();
    eWelcome_step++;
    break;
  case WELCOME_STEP_21:
    yellow_seg7_forward();
    eWelcome_step++;
    break;


  case WELCOME_STEP_22:
    yellow_to_white();
    eWelcome_step++;
    break;


  case WELCOME_STEP_23:
